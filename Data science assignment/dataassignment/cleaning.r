...
setwd('/Users/krijalshrestha/Desktop')

setwd('/Users/krijalshrestha/Desktop/Data science assignment/')

#________________------------------------____________________________________________

houseprice2019 = read_csv("housePricing/houseprice-2019.csv", show_col_types = FALSE)
houseprice2020 = read_csv('housePricing/houseprice-2020_2.csv', show_col_types = FALSE)
houseprice2021 = read_csv('housePricing/houseprice-2021_2.csv')
...
#___________________Cleaning OF School________________________________________
...
# Separate cleaning of school data of manchester and liverpool
